...
export async function openShop({
  ...
  // NEXA_SHOP_PRICE_SYNC_V1
  // Render langsung dari katalog supaya harga/label
  // yang tampil selalu sama dengan yang dipakai transaksi.
  const shopChoices =
    Object.entries(
      SHOP_ITEMS
    )
  ...
  const text =
    ...
    `${shopChoices}\n\n` +
    `💬 Reply pesan ini dengan nomor *1–${maxChoice}*\n` +
